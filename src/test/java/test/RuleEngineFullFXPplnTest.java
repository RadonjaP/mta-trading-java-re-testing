...
class RuleEngineFullFXPplnTest {
    ...
    void testEntrySignal_whenBaselineCrossed_andNotPullback_thenNoTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                .start(BASELINE_CROSSED)
                .add(BASELINE_CROSSED, SIGNAL_IS_PULLBACK_FALSE, HAS_CFRM_SIGNAL)
                .addOnlyTrue(SIGNAL_IS_PULLBACK_FALSE, ADD_PENDING_TRADE)
                .addOnlyTrue(HAS_CFRM_SIGNAL, HAS_2ND_CFRM_SIGNAL)
    ...
    void test_whenBaselineNotCrossed_andNoSignal_thenNoTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                ...
                .add(BASELINE_CROSSED_FALSE, SIGNAL_IS_PULLBACK_FALSE, HAS_CFRM_SIGNAL_FALSE)
                .addOnlyTrue(SIGNAL_IS_PULLBACK_FALSE, ADD_PENDING_TRADE)
                .addOnlyTrue(HAS_CFRM_SIGNAL, HAS_2ND_CFRM_SIGNAL)
                .add(HAS_2ND_CFRM_SIGNAL, BASELINE_MATCH_TREND, ADD_PENDING_TRADE)
                .addOnlyTrue(BASELINE_MATCH_TREND, CONTINUATION_TRADE)
    ...
    void test_whenBaselineNotCrossedAndSignal_andNoConfirmSignal_thenPendingTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                .start(BASELINE_CROSSED_FALSE)
                .add(BASELINE_CROSSED_FALSE, SIGNAL_IS_PULLBACK_FALSE, HAS_CFRM_SIGNAL)
                .addOnlyTrue(SIGNAL_IS_PULLBACK_FALSE, ADD_PENDING_TRADE)
                .addOnlyTrue(HAS_CFRM_SIGNAL, HAS_2ND_CFRM_SIGNAL_FALSE)
                .add(HAS_2ND_CFRM_SIGNAL_FALSE, BASELINE_MATCH_TREND, ADD_PENDING_TRADE)
                .addOnlyTrue(BASELINE_MATCH_TREND, CONTINUATION_TRADE)
                .add(CONTINUATION_TRADE, OPEN_TRADE, VOLUME_EXISTS)
                .addOnlyTrue(VOLUME_EXISTS, PRICE_TO_BASELINE_LTHAN_ATR)
                .addOnlyTrue(PRICE_TO_BASELINE_LTHAN_ATR, OPEN_TRADE)
    ...
    void test_whenBaselineNotCrossed_andSignals_baselineTrendNoMatch_thenNoTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                ...
                .addOnlyTrue(SIGNAL_IS_PULLBACK_FALSE, ADD_PENDING_TRADE)
                .addOnlyTrue(HAS_CFRM_SIGNAL, HAS_2ND_CFRM_SIGNAL)
                .add(HAS_2ND_CFRM_SIGNAL, BASELINE_MATCH_TREND_FALSE, ADD_PENDING_TRADE)
                .addOnlyTrue(BASELINE_MATCH_TREND_FALSE, CONTINUATION_TRADE)
                .add(CONTINUATION_TRADE, OPEN_TRADE, VOLUME_EXISTS)
                .addOnlyTrue(VOLUME_EXISTS, PRICE_TO_BASELINE_LTHAN_ATR)
                .addOnlyTrue(PRICE_TO_BASELINE_LTHAN_ATR, OPEN_TRADE)
                .build()
    ...
    void test_whenBaselineNotCrossed_andNotContinuationTrade_andNoVolume_noTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                ...
                .addOnlyTrue(HAS_CFRM_SIGNAL, HAS_2ND_CFRM_SIGNAL)
                .add(HAS_2ND_CFRM_SIGNAL, BASELINE_MATCH_TREND, ADD_PENDING_TRADE)
                .addOnlyTrue(BASELINE_MATCH_TREND, CONTINUATION_TRADE_FALSE)
                .add(CONTINUATION_TRADE_FALSE, OPEN_TRADE, VOLUME_EXISTS_FALSE)
                .addOnlyTrue(VOLUME_EXISTS_FALSE, PRICE_TO_BASELINE_LTHAN_ATR)
                .addOnlyTrue(PRICE_TO_BASELINE_LTHAN_ATR, OPEN_TRADE)
                .build()
                .run();
    ...
    void test_whenBaselineNotCrossed_andVolume_andPriceDistanceGreater_thenNoTrade() {
        ExecutionRs executionResult = new RuleEngineBuilder(new TestRuleRegistry())
                ...
                .add(HAS_2ND_CFRM_SIGNAL, BASELINE_MATCH_TREND, ADD_PENDING_TRADE)
                .addOnlyTrue(BASELINE_MATCH_TREND, CONTINUATION_TRADE_FALSE)
                .add(CONTINUATION_TRADE_FALSE, OPEN_TRADE, VOLUME_EXISTS)
                .addOnlyTrue(VOLUME_EXISTS, PRICE_TO_BASELINE_LTHAN_ATR_FALSE)
                .addOnlyTrue(PRICE_TO_BASELINE_LTHAN_ATR_FALSE, OPEN_TRADE)
                .build()
                .run();
